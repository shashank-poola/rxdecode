...
const Index = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Advanced text extraction using Tesseract.js to read handwritten and printed prescriptions."
    },
    {
      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          <div className="animate-fade-in">
            <h1 className="text-5xl md:text-7xl font-bold font-bricolage mb-6 bg-gradient-to-r from-rxdecode-purple via-rxdecode-coral to-rxdecode-blue bg-clip-text text-transparent">
              Medicine Recommendation System
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 mb-4 font-space">
